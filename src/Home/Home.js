...
class Home extends Component {
  ...
  async goToNext() {
    ...
    try {
      await this.postAnswer(currentQuizIndex, name, validity, reasonForValidity, difficulty, libraryName, selectedTypes, descriptionForType, dataFetchingTime);
  ...
  async loadNextExercise() {
    ...
    try {
      ...
      console.log("Current state: %d/%d", exerciseIndexListNextIndex,  NUMBER_OF_EXERCISES_TO_ANSWER);
      console.log("Quiz index: %d", nextQuizIndex);
  ...
  async fetchExercise(quizIndex) {
    ...
    console.log(self.currentExercise);
  }

  async postAnswer(quizIndex, name, validity, reasonForValidity, difficulty, libraryName, selectedTypes, descriptionForType, dataFetchingTime) {
        ...
        <div className="cp_form">
          <form>
            ...
            <div className="cp_group">
              ...
              <label className="cp_label" htmlFor="textarea">わからない/そう思わないと答えた場合、理由をお書きください。そう思うと答えた場合でも、演習問題として不適切な点があればお書きください。 </label>
              <i className="bar"></i>
            </div>
            ...
            <div className="cp_group">
              <textarea required="required" rows="2" onChange={ e => this.setState({ descriptionForType: e.target.value })}></textarea>
